...
AStarAlgorithm::AStarAlgorithm(FactoryMap* map) : m_FactoryMap(map)
{
...
bool AStarAlgorithm::IsValid(int row, int col)
{
...
// blocked or not
bool AStarAlgorithm::IsUnBlocked(int row, int col)
{
	// Returns true if the cell is not blocked else false
	if (m_FactoryMap->GetFieldFreeInformationOnPosition(row,col) == 1)
		return (true);
	else
		return (false);
}
...
// been reached or not
bool AStarAlgorithm::IsDestination(int row, int col, Pair dest)
{
...
double AStarAlgorithm::CalculateHValue(int row, int col, Pair dest)
{
